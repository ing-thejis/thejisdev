      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`mb-12 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="section-subtitle max-w-xl">
            A selection of projects where I applied my skills to solve real problems.
          </p>
              ...
              <button
                ...
                style={
                  activeFilter === filter.value
                    ? {
                      background: 'linear-gradient(135deg, #de0a26, #b8001f)',
                      color: '#fff',
                      boxShadow: '0 0 16px rgba(222,10,38,0.3)',
                    }
                    : {
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <h3
                      className="text-lg font-semibold text-white transition-colors group-hover:text-red-400"
                    >
                      {project.title}
                    </h3>
                  </div>
                ...
                {/* Expandable details */}
                <div className={`overflow-hidden overflow-y-auto transition-all duration-300 ${isExpanded ? 'max-h-64 mb-4' : 'max-h-0'}`}>
                  <div className="pt-3" style={{ borderTop: '1px solid #242424' }}>
                    <p className="text-xs mb-3" style={{ color: '#9ca3af' }}>{project.longDescription}</p>
                ...
                {/* Expand hint */}
                <div className="flex items-center gap-1 mt-4 text-xs transition-colors" style={{ color: '#52525b' }}>
                  <svg
